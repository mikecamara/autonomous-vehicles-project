...
def drive(cfg, model_path=None, use_joystick=False, model_type=None,
    ...
    def load_model(kl, model_path):
        ...
        kl.load(model_path)
        print('armandi finished loading in %s sec.' % (str(time.time() - start)) )
    ...
    if model_path:
        ...
        # the following didnt work as image/array was Null in advattack class

        # from donkeycar.parts.advattack import AdvAttack
        # # TODO pass out pred/ang/old from prediction within the attack
        # V.add(AdvAttack(kl), inputs=['cam/image_array', 'pilot/throttle'], outputs=['cam/image_array'])
    ...
    if cfg.STOP_SIGN_DETECTOR:
        ...
        V.add(StopSignDetector(cfg.STOP_SIGN_MIN_SCORE, cfg.STOP_SIGN_SHOW_BOUNDING_BOX,kl), inputs=['cam/image_array', 'pilot/throttle'], outputs=['pilot/throttle', 'cam/image_array'])
